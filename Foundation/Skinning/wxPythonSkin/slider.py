...
class slider(wxSkinLayoutObject, wxSkinObjectNoData):
    #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    def SkinInitialize(self):
        ...
        kwSettings = self.wxSettingDict(['wxid', 'style', 'pos', 'size', 'value', 'minValue', 'maxValue'], ['name'])
        kwSettings['point'] = kwSettings['pos']
        del kwSettings['pos']
        self.object = wx.wxSlider(winParent, **kwSettings)
