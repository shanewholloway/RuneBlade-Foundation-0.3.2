...
class mdi_child_frame(wxSkinWindowObject, wxSkinObjectNoData):
    #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    def SkinInitialize(self):
        self.PushContext()
        winParent = self.wxGetParentObject(wx.wxMDIParentFramePtr)
        kwSettings = self.wxSettingDict(['wxid', 'style', 'pos', 'size'], ['name', 'title'])
        self.object = wx.wxMDIChildFrame(winParent, **kwSettings)
