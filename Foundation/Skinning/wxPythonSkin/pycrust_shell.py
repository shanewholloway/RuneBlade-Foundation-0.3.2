...
class pycrust_shell(wxSkinLayoutObject, wxSkinObjectNoData):
    #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    def SkinInitialize(self):
        ...
        kwSettings = self.wxSettingDict(['wxid', 'style', 'pos', 'size', 'locals'], ['introText'])
        self.object = shell.Shell(winParent, **kwSettings)
