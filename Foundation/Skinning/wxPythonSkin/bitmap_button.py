...
class wxBitmapButtonWithRollover(wx.wxBitmapButton):
    #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    def _SetRolloverBitmap(self, evt):
        self._nonrollover_bitmap = self.GetBitmapLabel()
        self.SetBitmapLabel(self._rollover_bitmap)
        self.Refresh()
        evt.Skip()

    def _SetNonRolloverBitmap(self, evt):
        if self._nonrollover_bitmap:
            self.SetBitmapLabel(self._nonrollover_bitmap)
...
class bitmap_button(wxSkinLayoutObject, wxSkinObjectNoData):
    ...
    def SkinInitialize(self):
        ...
        #self.object = wx.wxBitmapButton(winParent, **kwSettings)
        self.object = wxBitmapButtonWithRollover(winParent, **kwSettings)
