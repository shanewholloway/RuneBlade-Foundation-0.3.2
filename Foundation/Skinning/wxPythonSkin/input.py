...
class input(wxSkinLayoutObject):
    #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    def SkinInitialize(self):
        ...
        kwSettings = self.wxSettingDict(['wxid', 'style', 'pos', 'size'], ['name', 'value'])
        kwSettings['value'] = kwSettings['value'] or ''.join(self.Content())
        self.object = wx.wxTextCtrl(winParent, **kwSettings)
